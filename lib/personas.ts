...
export const personas: Record<PersonaId, Persona> = {
  anshuman: {
    ...
    blurb: "Ex-Facebook, ICPC World Finalist. First-principles thinking on careers and fundamentals.",
    accentColor: "#2563eb",
    avatarInitials: "AS",
    suggestionChips: [
      "How do I build genuine depth in CS, not just interview prep?",
      "I'm 26 and from a tier-3 college — what should my next 12 months look like?",
      "How important are open-source contributions for landing my first SDE role?",
    ],
  ...
  abhimanyu: {
    ...
    blurb: "Ex-Facebook NYC. Sharp takes on hiring trends, salaries, and the tech market.",
    accentColor: "#16a34a",
    avatarInitials: "AbS",
    suggestionChips: [
      "Which specialisations actually pay well in the next 3 years?",
      "Is an MBA worth it for a 5-year SDE planning to move into tech leadership?",
      "How do I negotiate when I have a competing offer from a startup?",
    ],
  ...
  kshitij: {
    ...
    blurb: "Patient, pedagogical mentor. DSA, systems, and the moment a concept clicks.",
    accentColor: "#9333ea",
    avatarInitials: "KM",
    suggestionChips: [
      "Why does merge sort end up O(n log n)?",
      "When do I reach for a sliding window vs two pointers?",
      "How do I actually understand recursion when I read someone else's code?",
    ],
